...
export class RoutesService {
  ...
  static ROOT_CONFIG = {
    ...
    foo: {name: 'foo', path: '/foo', label: 'Foo Page'},
    bar: {name: 'bar', path: '/bar', label: 'Bar Page'},
  };
   ...
   */
  static FOO_CONFIG = {
    fooone: {name: 'fooone', path: '/foo/fooone', label: 'Foo Page One'},
    footwo: {name: 'footwo', path: '/foo/footwo', label: 'Foo Page Two'},
  };
  ...
  private init() { this.updateCurrentPageDataOnRouteChange(); }
   ...
   * (root/foo/foo_routing_module.ts, etc.).
   */
