...
export class Foo implements OnInit, OnDestroy {
   ...
   */
  ngOnDestroy() { this.activeSecondaryPageSubscription.unsubscribe(); }
   ...
   * route definitions in root/foo/foo_routing_module.ts.
   */
   ...
   * When navigating to a relative path imperatively (in the component, as
